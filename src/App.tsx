    ...
    <footer className="bg-slate-50 dark:bg-slate-900 border-t border-lab-border dark:border-slate-800 py-12">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex gap-4">
          ...
          <a aria-label="Instagram" className="p-2 border border-slate-200 dark:border-slate-700 hover:bg-white hover:border-primary transition-all text-slate-600 dark:text-slate-400 group" href="https://www.instagram.com/szczessny" target="_blank" rel="noreferrer">
